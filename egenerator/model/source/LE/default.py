...
class DefaultLEModel(Source):
    ...
    def __init__(self, logger=None):
        ...
        super(DefaultLEModel, self).__init__(logger=self._logger)
    ...
    def get_tensors(self, data_batch_dict, is_training,
        ...
        modified_parameters = tf.stack(x_parameters_expanded[:3] #pos
                                       ...
                                       + [tf.math.log1p(parameter_list[7])], #trck energy
                                       axis=-1)
        '''
        ...
        latent_mu = 0.7 + factor_mu * latent_mu
