...
class ChargeQuantileCascadeModel(Source):
    ...
    def get_tensors(
        ...
        pulse_dom_charge_true_trafo = 0.1 * tf.math.log(
            pulse_dom_charge_true + 1.0
        )
        pulse_dom_charge_trafo = 0.1 * tf.math.log(pulse_dom_charge + 1.0)
        ...
        # shape: [n_pulses, 1]
        pulse_light_propagation_time = tf.gather_nd(
            light_propagation_time, pulses_ids
        )
