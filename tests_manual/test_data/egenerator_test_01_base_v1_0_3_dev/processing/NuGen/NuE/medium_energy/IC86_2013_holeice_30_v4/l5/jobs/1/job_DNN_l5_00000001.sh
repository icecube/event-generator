...
times[0]=$SECONDS
step_counter=1
OUT_DIR=/data/user/mhuennefeld/software/repositories/event-generator/tests_manual/test_data/egenerator_test_01_base_v1_0_3_dev/processing/NuGen/NuE/medium_energy/IC86_2013_holeice_30_v4/l5/jobs/1/steps_DNN_l5_00000001
...
echo '=========================' &&
echo &&
eval "${OUT_DIR}/job_DNN_l5_00000001_step_0000.sh" && 
...
echo '=========================' &&
echo &&
eval "${OUT_DIR}/job_DNN_l5_00000001_step_0001.sh" && 
times[$step_counter]=$SECONDS &&
((step_counter++)) &&
...
echo '   ... removing ./temp_step_files/NuGen/NuE/medium_energy/IC86_2013_holeice_30_v4/l5/1/DNN_l5_00000001_step0000*'
rm ./temp_step_files/NuGen/NuE/medium_energy/IC86_2013_holeice_30_v4/l5/1/DNN_l5_00000001_step0000*
