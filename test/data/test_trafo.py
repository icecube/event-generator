...
class TestDataTransformer(unittest.TestCase):
    ...
    #         self.data_trafo.configure(data_handler=data_handler,
    #                                   data_iterator=None, num_batches=None)
    ...
    #         self.assertEqual(data_trafo.data['config'], config)
    #         self.assertEqual(data_trafo.data['skip_keys'], skip_keys)
    #         self.assertTrue(
    #             data_trafo.data['tensors'] == data_handler.tensors)
    ...
    #     # create trafo model
    #     self.assertFalse(data_trafo.is_configured)
    #     data_trafo.configure(
    #         data_handler=data_handler, data_iterator=data_iterator,
    #         num_batches=data_handler.n_batches)
    #     self.assertTrue(data_trafo.is_configured)
    ...
    #     with self.assertRaises(ValueError) as context:
    #         data_trafo.configure(data_iterator,
    ...
    #         data_trafo.save(file_path, overwrite=False)
