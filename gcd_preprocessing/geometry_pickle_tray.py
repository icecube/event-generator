...
@click.option('--base_dir', default="/data/user/jvara/egenerator_tutorial/repositories_original/event-generator/gcd_preprocessing/geometry_pickles", help='Base directory to save the pickle files')
def main(gcd, om_name, base_dir):
    file_name = str(gcd)
