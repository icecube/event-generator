...
class generate_geometry_pickle(icetray.I3ConditionalModule):
    """
    ...
    def Calibration(self,frame):
        ...
        om_dict["num_pmts"]=len(set_pmts_per_module)
        
        
        #Define the dom coordinates
        
        dom_coordinates = np.zeros((om_dict["num_strings"],om_dict["doms_per_string"],om_dict["num_pmts"],3))
        ...
        dom_coordinates = dom_coordinates.reshape(om_dict["num_strings"], om_dict["doms_per_string"] * om_dict["num_pmts"], 3)
        ...
        dom_azimuths = np.zeros((om_dict["num_strings"],om_dict["doms_per_string"],om_dict["num_pmts"],))
        dom_zeniths = np.zeros((om_dict["num_strings"],om_dict["doms_per_string"],om_dict["num_pmts"],))
        ...
        dom_azimuths = dom_azimuths.reshape(om_dict["num_strings"], om_dict["doms_per_string"] * om_dict["num_pmts"])
        dom_zeniths = dom_zeniths.reshape(om_dict["num_strings"], om_dict["doms_per_string"] * om_dict["num_pmts"])
        ...
        dom_rel_eff = np.zeros((om_dict["num_strings"], om_dict["doms_per_string"], om_dict["num_pmts"],))
        dom_noise_rates = np.zeros((om_dict["num_strings"], om_dict["doms_per_string"], om_dict["num_pmts"],))
        ...
        dom_rel_eff = dom_rel_eff.reshape(om_dict["num_strings"], om_dict["doms_per_string"] * om_dict["num_pmts"])
        dom_noise_rates = dom_noise_rates.reshape(om_dict["num_strings"], om_dict["doms_per_string"] * om_dict["num_pmts"])
