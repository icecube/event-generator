    ...
    for file_name in file_names:
        ...
        while f.more():
            ...
            if fr.Stop.id == 'X':
                ...
                break
            elif (fr.Stop == icetray.I3Frame.DAQ or
    ...
    def Finish(self):
        ...
        if self._merge:
            ...
            if not np.allclose(
                ...
                raise ValueError('Livetimes do not match up: {} != {}'.format(
                    self._livetime, self._merge_livetime))
            ...
            if not np.allclose(self._end_times, self._merge_end_times):
                raise ValueError('End times do not match up: {} != {}'.format(
