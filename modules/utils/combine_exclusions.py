...
# from icecube.tableio import I3Converter, I3TableRowDescription, I3Datatype
# from icecube.icetray import I3Int

# class TimeWindowSeriesMapConverter(I3Converter):
...
#         desc.add_field("value", I3Datatype(classification), "", "descriptio")
#         return

#     def FillRows(self, obj, rows):
#         rows.set("value", obj.value)
#         return 1
