...
def modify_brights(frame, pulse_key, brights_variation,
    ...
    if not brights_variation is None:
        ...
        if verbose:
            ...
            msg = '[BrightTest] Removed {} DOMs and {} additional pulses from {}'
            # ToDo: use logging
            print(  msg.format( num_removed,
                            num_rm_pulses,
                            pulse_key ))

    frame[pulse_key+'_brights_modified'] = pulses
    # -------------------------------
